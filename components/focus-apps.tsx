      ...
      <main className="flex-grow pt-16">
        <section id="home" className="py-20 text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Discover our suite of beautifully designed and highly functional
              apps that will transform the way you interact with social media
              and content.
            </p>
            <a
              href="#apps"
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              At Focus, we&apos;re passionate about creating beautiful,
              functional apps that enhance your digital life. Our team of
              dedicated developers and designers work tirelessly to bring you
              the best possible user experience across all our applications.
            </p>
            <a
              href="#contact"
              onClick={(e) => {
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              ...
              out to our team and let us know how we can help improve your
              experience with our apps.
            </p>
            <a
              href="mailto:product@focusapps.app"
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-300"
            >
              Contact Us
              <ArrowRight className="ml-2 -mr-1 h-5 w-5" aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Focus creates beautiful and functional apps to enhance your
                digital experience.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="https://twitter.com/allentown521"
                  target="blank"
                  className="text-gray-400 hover:text-white transition-colors duration-300"
                >
                ...
                <a
                  href="https://github.com/allentown521"
                  target="blank"
                  className="text-gray-400 hover:text-white transition-colors duration-300"
                >
        ...
        <div className="flex flex-wrap gap-4">
          ...
          {forChinaLink && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-4 py-2 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-300"
            >
              For China
              <ArrowRight className="ml-2 -mr-1 h-5 w-5" aria-hidden="true" />
            </a>
